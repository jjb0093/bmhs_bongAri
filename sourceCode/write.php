...
<html lang="ko">
<head>
  <title>지원서 작성 (<?echo $row['clubName'];?>)</title>
  <meta charset="utf-8">
...
<body>
  ...
  <form method="post" action="write_Check?id=<?echo $clubID;?>">
    <div id="stuInfo">
    ...
    <div id="form">
      <? for($i=1;$i<=6;$i++){ if($row_f['ques_'.$i]==null) break; ?>
        ...
        <textarea required placeholder="항상 신중하고, 진지하게. 한 번 선택한 동아리가 1년의 생기부를 결정합니다." name="ans_<?echo $i?>" rows="5"></textarea><br><br><br>
      <? } ?>
